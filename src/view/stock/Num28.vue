...
function refreshDate(queryParam) {
  axios.post(AxiosUrl.stock.stockQuery.saveDate, {
    ...
    dateBeginStr: queryParam == null || queryParam.dateStr == null ? ConfigInfo.nowDate : queryParam.dateStr,
    dateEndStr: queryParam == null || queryParam.dateStr == null ? ConfigInfo.nowDate : queryParam.dateStr,
  }).then();
}
...
function getDayDetail(){
  axios.post(AxiosUrl.stock.stockQuery.getAllStatic, {
