  ...
  <el-dialog v-model="dialogFormVisible" title="卖出信息" append-to-body>
    ...
    <el-form :model="strategyInfo">
      ...
      <el-form-item label="代码"   :label-width="formLabelWidth">
        <el-input v-model="strategyInfo.code"   ></el-input>
      </el-form-item>
      <el-form-item label="名称" :label-width="formLabelWidth">
        <el-input v-model="strategyInfo.name" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item label="价格" :label-width="formLabelWidth">
        <el-input v-model="strategyInfo.price" ></el-input>
      </el-form-item>
...
export default {
  ...
  setup(props) {
    ...
    function clickConfirmDialog() {
      axios.post(AxiosUrl.stock.trade.modifySellInfo, props.strategyInfo).then()
